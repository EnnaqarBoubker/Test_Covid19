function testCovide19(obj) {
    if (obj.boubker() == true) {
        if (obj.pronostique() == 0) {
            ...
            } else if ((obj.gravite() == 0 && (obj.age > 50 || obj.age <= 69)) || (obg.graviteMineur() >= 1)) {
                console.log(`téléconsultation ou médecin généraliste ou visite à domicile oooooooooo`);
            }
